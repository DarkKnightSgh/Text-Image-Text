...
# Streamlit app
st.set_page_config(page_title="Image Caption Search")
st.title("Image Caption Search")
...
if uploaded_file is not None:
    ...
    model_dir = "/Users/sirigowrih/Desktop/AiWR Project/encoder_model"  # Replace with the actual path to the extracted model directory
    caption_file_path = "/Users/sirigowrih/Desktop/AiWR Project/Flickr8/captions.txt"
    ...
    for i, (caption, bleu_score, image_path) in enumerate(zip(top_captions, top_bleu_scores, top_image_paths)):
        full_image_path = os.path.join("/Users/sirigowrih/Desktop/AiWR Project/Flickr8/Images/", image_path)
